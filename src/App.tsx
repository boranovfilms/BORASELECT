...
import ConfigurarFluxo from './pages/ConfigurarFluxo';
  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/clients/:id/configurar-fluxo/:demandType" element={user && isAdmin ? wrapLayout(<ConfigurarFluxo />) : <Navigate to="/" />} />
