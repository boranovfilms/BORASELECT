...
export default function Teleprompter() {
  ...
  return (
    <div className="min-h-[80vh] flex flex-col overflow-x-hidden max-w-[100vw] animate-in fade-in duration-700">
      <style>{`
        .pill-range-input {
      ...
      {selectedMode === 'remote' && (
        <div className="min-h-[85vh] flex flex-col gap-6 max-w-lg mx-auto pb-10 px-4">
