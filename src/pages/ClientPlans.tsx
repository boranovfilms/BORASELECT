...
export default function ClientPlans() {
  ...
  const loadMyPlans = async () => {
    ...
    try {
      ...
      // 1. Busca o ID do documento do cliente diretamente na coleção 'clients' pelo e-mail
      ...
      if (!clientSnap.empty) {
        ...
        // Caso o usuário logado não seja um cliente (ex: Admin sem registro na col 'clients')
