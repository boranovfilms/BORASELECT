...
export default function ClientAccess() {
  ...
  const handleSaveClient = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Se for novo, cria primeiro para ter o ID
      if (isNew) {
      ...
      // Realiza o upload se houver um novo preview (base64)
      if (logoPreview && logoPreview.startsWith('data:image')) {
        try {
          ...
          if (upResponse.ok) { 
            ...
            console.error('Falha no upload do logo');
          }
        } catch (uploadError) {
      ...
      // Salva ou atualiza os dados no Firestore com a logoUrl correta
      ...
      // Só limpa o preview e fecha o formulário após sucesso total
      setLogoPreview('');
