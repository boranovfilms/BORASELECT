                  ...
                  <div className="w-full md:w-64 space-y-2 shrink-0">
                    ...
                    <div className="relative">
                      <select 
                        ...
                        className="w-full bg-zinc-900 border border-zinc-800 rounded-xl h-12 px-4 text-sm text-white focus:border-[#ff5351] outline-none appearance-none cursor-pointer shadow-lg"
                      >
