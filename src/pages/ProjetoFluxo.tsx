        ...
        {workflow.status === 'completed' ? (
          ...
          <div className="max-w-4xl mx-auto space-y-8 pb-12">
            <header className="pb-8 border-b border-zinc-800 flex justify-between items-start">
              ...
              {/* Botão de salvar configurações de mídia se estiver na tela "Subir Cortes" */}
              {isSubirCortes && (
            ...
            {/* SE FOR "SUBIR CORTES": MOSTRA INTERFACE IGUAL AO PROJECTCONFIG ORIGINAL */}
            {isSubirCortes ? (
                                ...
                                <div className="flex items-center gap-3 overflow-hidden">
                                  ...
                                  <div className="overflow-hidden">
                                    ...
                                    <p className="text-[8px] font-bold text-zinc-500 uppercase tracking-widest mt-0.5">
                                      {upload.status === 'pending' ? 'Pendente' : upload.status === 'uploading' ? 'Enviando...' : upload.status === 'completed' ? 'Concluído' : 'Erro no envio'}
                                    </p>
                                  </div>
                                </div>
